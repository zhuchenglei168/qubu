    ...
    var b = function() {
        ...
        var f = function(y) {
            ...
            if (y > 0) {
                ...
                p.attr("sel", "1").attr("class", "z-pay-mentsel").next("span").html('夺宝币支付<em class="orange">' + y + ".00</em>元（账户夺宝币：" + d + " 元）")
				checkpay='money';
				banktype='nobank';
            } else {
                p.attr("sel", "0").attr("class", "z-pay-ment").next("span").html('夺宝币支付<em class="orange">0.00</em>元（账户夺宝币：' + d + " 元）")
            }
        };
        var k = function(y) {
            e = y;
