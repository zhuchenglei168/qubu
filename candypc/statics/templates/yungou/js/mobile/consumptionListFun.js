                ...
                function(D) {
                    ...
                    if (D.code == 0) {
                        ...
                        if (v.isCount == 1) {
                            ...
                            B = '<li class="m-userMoneylst-tt"><span>时间</span><span>数量</span><span>描述</span></li>'
                ...
                function(D) {
                    ...
                    if (D.code == 0) {
                        ...
                        if (v.isCount == 1) {
                            ...
                            B = '<li class="m-userMoneylst-tt"><span>时间</span><span>描述</span></li>'
                        ...
                        for (var z = 0; z < A; z++) {
                            ...
                            B += '<li class="' + (z + 1 == A ? "bornone": "") + '"><span>' + C[z].time + "</span><span>花费 " + C[z].money +"夺宝币"+ C[z].content + "</span></li>"
