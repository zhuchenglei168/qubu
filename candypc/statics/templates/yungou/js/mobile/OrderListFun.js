               ...
               // GetJPData("http://m.1yyg.com", "getUserOrderList", j(),
                ...
                function(p) {				 
                    ...
                    if (p.code == 0) {
                        ...
                        for (var l = 0; l < n; l++) {						 
if(o[l].money==o[l].yunjiage){
	   m += "<li click=\"location.href='"+Gobal.Webpath+"/mobile/user/buyDetail/" + o[l].shopid +'\'"><a class="fl z-Limg" href="'+Gobal.Webpath+'/mobile/mobile/item/' + o[l].shopid +'"><img src="' + Gobal.LoadPic + '" src2="'+Gobal.imgpath+'/uploads/' + o[l].thumb + '" border=0 alt=""/></a><div class="u-gds-r gray9"><p class="z-gds-tt"><a href="'+Gobal.Webpath+'/mobile/mobile/item/' + o[l].shopid +'" class="gray6">(第' + o[l].qishu + "期)" + o[l].shopname + '</a></p><p>购买时间<em class="orange">' + "</em></p><p>" + o[l].q_end_time + "</p>";
}else{
