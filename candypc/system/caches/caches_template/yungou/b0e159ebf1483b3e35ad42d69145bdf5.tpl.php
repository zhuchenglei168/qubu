...
<!-- 内页顶部 -->
   ...
   <section>
	<div class="mainCon">
    	<div class="mBanner">
        	<ul>
            	<li class="mUserHead"><img src="<?php echo $member['img']; ?>"></li><li class="mUserInfo"><p><?php echo get_user_name($member['uid']); ?></p><br/>梦想分：<?php echo $member['score']; ?><br/><?php echo $member['yungoudj']; ?><span class="z-class-icon03"></span></li>
            </ul>
        </div>
