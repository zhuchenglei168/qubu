    ...
    <section class="clearfix g-member">
	    <div class="clearfix m-round m-name">
			...
			<p class="u-name">
				...
				<li>夺宝币 <span class="orange"><?php echo $member['money']; ?></span>
				<a href="<?php echo WEB_PATH; ?>/mobile/home/userrecharge" class="fr z-Recharge-btn">充值</a><a href="<?php echo WEB_PATH; ?>/mobile/home/duihuan" class="fr z-Recharge-btn">糖果兑换</a></li>
				</ul>
			</div>
		</div>
	    <div class="m-round m-member-nav">
		    <ul id="ulFun">
		    	<li><a href="<?php echo WEB_PATH; ?>/mobile/home/userqiandao"><b class="z-arrow"></b>每日签到</a></li>
			    <li><a href="<?php echo WEB_PATH; ?>/mobile/home/userbuylist"><b class="z-arrow"></b>云购记录</a></li>
			    <li><a href="<?php echo WEB_PATH; ?>/mobile/home/orderlist"><b class="z-arrow"></b>获得商品</a></li>
			    ...
			    <li><a href="<?php echo WEB_PATH; ?>/mobile/home/userbalance"><b class="z-arrow"></b>帐户明细</a></li>
                 		   ...
                 		   <li><a href="<?php echo WEB_PATH; ?>/mobile/home/zhuanzhang"><b class="z-arrow"></b>用户转账</a></li>

                 		   <li><a href="<?php echo WEB_PATH; ?>/mobile/home/address"><b class="z-arrow"></b>地址管理</a></li>                   
                 		   <li><a href="<?php echo WEB_PATH; ?>/mobile/home/inviteshare"><b class="z-arrow"></b>如何糖果夺宝</a></li>
