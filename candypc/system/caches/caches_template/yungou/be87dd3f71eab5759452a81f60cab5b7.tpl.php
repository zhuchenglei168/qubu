...
.tab_load_more {
  ...
  <div class="zxjx">
    <a href="<?php echo WEB_PATH; ?>/mobile/mobile/lottery">最新揭晓<label style="position:absolute; right:1rem; cursor:pointer">显示全部&nbsp;></label></a>
    <ul class="ul ">
      <script>
        (function(){
      ...
      <li>
        <a href="<?php echo WEB_PATH; ?>/mobile/mobile/item/<?php echo $qishu['id']; ?>" id="r<?php echo $qishu['id']; ?>" title="<?php echo WEB_PATH; ?>/mobile/mobile/itemajax/<?php echo $qishu['id']; ?>">
          ...
          <div class="txt" style="">
            ...
            <div class="zj"><span>中奖</span><span style="color: #5bb6ea;"><?php echo get_user_name($qishu['q_uid'],'username'); ?></span></div>
            <?php  else: ?>
            <div class="zj">
  ...
  <div class="tabs-wrap" style="min-height:1000px;">
    <div class="zxjx">
      <a href="<?php echo WEB_PATH; ?>/mobile/mobile/glist" class="tab_selected" data-order_by='level'>最新奖品<label style="position:absolute; right:1rem; cursor:pointer">显示全部&nbsp;></label></a>
    </div>
    <div class="tabs-content">
      ...
      <?php $ln=1;if(is_array($shoplistrenqi)) foreach($shoplistrenqi AS $renqi): ?>
           ...
           <a id="prize_url" href="javascript:;" class="add1" codeid="<?php echo $renqi['id']; ?>" >
             ...
             <h6 id="prize_title"><?php echo $renqi['title']; ?></h6>
             <div class="item_bottom_container">
               <div class="jdt_container">
                 <div>进度&nbsp;<label class="color_blue" id="jd"><?php echo percent($renqi['canyurenshu'],$renqi['zongrenshu']); ?></label></div>
...
<footer class="footer">
   <!-- <div class="u-ft-nav" id="fLoginInfo">
    ...
    <p class="m-ftA">
      <a href="<?php echo WEB_PATH; ?>/mobile/mobile">触屏版</a>|<a href="<?php echo WEB_PATH; ?>">电脑版</a> 
    </p>
 ...
 <script src="<?php echo G_TEMPLATES_JS; ?>/mobile/main.js"></script> 
   ...
   <div class="footerdi" style="bottom: 0px;">
    <ul>
      ...
      <li class="f_whole">
        <a title="全部奖品" href="<?php echo WEB_PATH; ?>/mobile/mobile/glist"><i class="<?php echo $f_whole; ?>">&nbsp;</i>全部奖品</a>
      </li>
      <li class="f_jiexiao">
        <a title="最新揭晓" href="<?php echo WEB_PATH; ?>/mobile/mobile/lottery"><i class="<?php echo $f_jiexiao; ?>">&nbsp;</i>最新揭晓</a>
      </li>
      <li class="f_car">
        <a title="首页" href="<?php echo WEB_PATH; ?>/mobile/shaidan"><i class="<?php echo $f_car; ?>">&nbsp;</i>晒单</a>
      </li>
      <li class="f_personal">
        <a title="首页" href="<?php echo WEB_PATH; ?>/mobile/home"><i class="<?php echo $f_personal; ?>">&nbsp;</i>个人中心</a>
      <li>
    </ul>
   </div>
  </body>
