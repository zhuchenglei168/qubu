...
E_D("replace into `go_template` values('index.buyrecord.html','yungou','云购记录');");
E_D("replace into `go_template` values('index.buyrecordbai.html','yungou','最新云购记录');");
...
E_D("replace into `go_template` values('member.userbuydetail.html','yungou','云购记录');");
E_D("replace into `go_template` values('member.userbuylist.html','yungou','云购记录');");
...
E_D("replace into `go_template` values('us.userbuy.html','yungou','个人主页云购记录');");
E_D("replace into `go_template` values('us.userpost.html','yungou','个人主页云购记录');");
E_D("replace into `go_template` values('us.userraffle.html','yungou','个人主页云购记录');");
