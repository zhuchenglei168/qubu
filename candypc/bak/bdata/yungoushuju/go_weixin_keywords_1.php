...
E_D("replace into `go_weixin_keywords` values('105','文本消息测试','text','1','您现在看到的公众号平台是我们独立设计完成的接口，完美对接网站现在已有的系统，实现了在微信中的各种功能的完美对接，购买咨询请联系QQ：913968520','','','','','105','1');");
