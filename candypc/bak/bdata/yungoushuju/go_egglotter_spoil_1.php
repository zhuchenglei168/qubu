...
E_D("replace into `go_egglotter_spoil` values('1','1','洗衣粉','20','1',NULL,'1472532625');");
E_D("replace into `go_egglotter_spoil` values('2','1','游戏机','40','2',NULL,'1472532625');");
E_D("replace into `go_egglotter_spoil` values('3','1','手机','40','3',NULL,'1472532625');");
