...
class Memcache {
	...
	public function read($sessID) {
        return $this->handle->get($this->prefix.$sessID);
	}
	...
	public function write($sessID, $sessData) {
		return $this->handle->set($this->prefix.$sessID, $sessData, 0, $this->lifeTime);
	}
	...
	public function destroy($sessID) {
		return $this->handle->delete($this->prefix.$sessID);
	}
