...
class SchoolController extends CommonController {
 ...
 // 文章列表
	public function getfk() {
      ...
      $_result['content']=htmlspecialchars_decode($_result['content']);
      $_result['encontent']=htmlspecialchars_decode($_result['encontent']);
        $_result['createDate']=date('Y-m-d H:i:s',$_result['create_date']);
