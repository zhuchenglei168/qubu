...
E_D("replace into `go_config` values('1','web_name','林心云购','网站名');");
E_D("replace into `go_config` values('2','web_key','云购|一元云购|云购系统|购物|一元购物','网站关键字');");
E_D("replace into `go_config` values('3','web_des','1元云购是一种全新的购物方式,是时尚、潮流的风向标,能满足个性、年轻消费者的购物需求。\n','网站介绍');");
E_D("replace into `go_config` values('4','web_path','http://www.altui.com','网站地址');");
...
E_D("replace into `go_config` values('20','cell','400600800','联系电话');");
E_D("replace into `go_config` values('21','web_logo','banner/20160523/25968183995356.png','logo');");
E_D("replace into `go_config` values('22','web_copyright','Copyright © 2011 - 2015, 版权所有 粤ICP备09213115号-1','版权');");
E_D("replace into `go_config` values('23','web_name_two','林心云购','短网站名');");
