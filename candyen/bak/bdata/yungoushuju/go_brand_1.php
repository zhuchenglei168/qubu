...
E_C("CREATE TABLE `go_brand` (
  ...
  KEY `status` (`status`),
  KEY `order` (`order`)
) ENGINE=MyISAM AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 COMMENT='品牌表'");
E_D("replace into `go_brand` values('1','5','Y','联想','16');");
E_D("replace into `go_brand` values('2','5','Y','诺基亚','1');");
E_D("replace into `go_brand` values('3','5','Y','苹果','1');");
E_D("replace into `go_brand` values('4','5','Y','三星','14');");
E_D("replace into `go_brand` values('6','5','Y','小米','1');");
E_D("replace into `go_brand` values('7','5','Y','oppo','1');");
E_D("replace into `go_brand` values('8','5','Y','HTC','15');");
E_D("replace into `go_brand` values('10','6','Y','苹果','1');");
E_D("replace into `go_brand` values('11','6','Y','三星','1');");
E_D("replace into `go_brand` values('12','6','Y','台电','13');");
E_D("replace into `go_brand` values('13','12','Y','尼康','3');");
E_D("replace into `go_brand` values('14','6','Y','台电','1');");
E_D("replace into `go_brand` values('15','13','Y','尼康','1');");
E_D("replace into `go_brand` values('16','5','Y','诺基亚','1');");
E_D("replace into `go_brand` values('17','6','Y','苹果','1');");
E_D("replace into `go_brand` values('18','6','Y','小米','1');");
E_D("replace into `go_brand` values('19','6','Y','oppo','1');");
E_D("replace into `go_brand` values('20','6','Y','海尔','1');");
E_D("replace into `go_brand` values('21','6','Y','美的','1');");
E_D("replace into `go_brand` values('22','6','Y','华为','1');");
E_D("replace into `go_brand` values('23','6','Y','魅族','1');");
E_D("replace into `go_brand` values('24','6','Y','NOKIA','1');");
E_D("replace into `go_brand` values('25','6','Y','VIVO','1');");
E_D("replace into `go_brand` values('26','6','Y','HTC','1');");
E_D("replace into `go_brand` values('27','6','Y','OPPO','1');");
