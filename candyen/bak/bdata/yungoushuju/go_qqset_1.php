...
E_D("replace into `go_qqset` values('10','129019201','??1?','???','http://qun.qq.com/','??','??','???','?????','1440475030');");
E_D("replace into `go_qqset` values('11','131434343','????2?','???','http://qun.qq.com/','??','??','???','?????','1440475036');");
E_D("replace into `go_qqset` values('12','212113145','?????~','???','http://qun.qq.com/','??','??','???','?????','1440475041');");
E_D("replace into `go_qqset` values('13','12046847854','?????','???','http://qun.qq.com/','??','??','???','?????','1440475046');");
E_D("replace into `go_qqset` values('14','890890','90???','???','http://qun.qq.com/','??','??','???','?????','1440475051');");
