...
DoSetDbChar('utf8');
E_D("DROP TABLE IF EXISTS `go_member_cashout`;");
E_C("CREATE TABLE `go_member_cashout` (
  ...
  KEY `uid` (`uid`),
  KEY `type` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='会员账户明细'");
E_D("replace into `go_member_cashout` values('1','1','崔银明','中国建行','上海分行','100','1443447238','6225002465814952','18649625719','1','0.00','');");
