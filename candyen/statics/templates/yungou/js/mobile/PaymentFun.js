    ...
    var b = function() {
        ...
        var f = function(y) {
            ...
            if (y > 0) {
                ...
                p.attr("sel", "1").attr("class", "z-pay-mentsel").next("span").html('夺宝币支付<em class="orange">' + y + ".00</em>（账户夺宝币：" + d + " ）")
                ...
                p.attr("sel", "0").attr("class", "z-pay-ment").next("span").html('夺宝币支付<em class="orange">0.00</em>（账户夺宝币：' + d + " ）")
        ...
        $("li", m).each(function(y) {
            ...
            if (y == 0) {
                ...
                z.click(function() {
                    ...
                    h.html('<s class="z-arrow"></s>选择<b class="z-mlr">' + r + "</b>支付" + ((g > 0 || w > 0) ? "剩余": "") + '<em class="orange">' + e + ".00</em>夺宝币")
        ...
        if (e > 0) {
            ...
            h.removeClass("z-pay-grayC").html('<s class="z-arrow"></s>select <b class="z-mlr">' + r + "</b> pay" + ((g > 0 || w > 0) ? "surplus": "") + '<em class="orange">' + e + ".00</em>").nextAll().show();
			    ...
			    if (shopnum != -1) {
					...
					if (shopnum == 0) {
						...
						if (shopnum == 1) {
							...
							alert("Dear, there are no goods in your shopping cart. Go and buy some.");
