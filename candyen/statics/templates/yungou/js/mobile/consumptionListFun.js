                ...
                function(D) {
                    ...
                    if (D.code == 0) {
                        ...
                        if (v.isCount == 1) {
                            ...
                            B = '<li class="m-userMoneylst-tt"><span>Time</span><span>Number</span><span>Describe</span></li>'
                ...
                function(D) {
                    ...
                    if (D.code == 0) {
                        ...
                        if (v.isCount == 1) {
                            ...
                            B = '<li class="m-userMoneylst-tt"><span>Time</span><span>Describe</span></li>'
                        ...
                        for (var z = 0; z < A; z++) {
                            ...
                            B += '<li class="' + (z + 1 == A ? "bornone": "") + '"><span>' + C[z].time + "</span><span>consume  " + C[z].money +" money "+ C[z].content + "</span></li>"
