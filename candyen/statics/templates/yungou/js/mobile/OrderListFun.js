                ...
                function(p) {				 
                    ...
                    if (p.code == 0) {
                        ...
                        for (var l = 0; l < n; l++) {						 
                            ...
                            m += "<li onclick=\"location.href='"+Gobal.Webpath+"/mobile/user/buyDetail/" + o[l].shopid +'\'"><a class="fl z-Limg" href="'+Gobal.Webpath+'/mobile/mobile/item/' + o[l].shopid +'"><img src="' + Gobal.LoadPic + '" src2="'+Gobal.imgpath+'/uploads/' + o[l].thumb + '" border=0 alt=""/></a><div class="u-gds-r gray9"><p class="z-gds-tt"><a href="'+Gobal.Webpath+'/mobile/mobile/item/' + o[l].shopid +'" class="gray6">(Phase ' + o[l].qishu + ")" + o[l].shopname + '</a></p><p>Lucky code：<em class="orange">' + o[l].q_user_code + "</em></p><p>Opening time：" + o[l].q_end_time + "</p>";
