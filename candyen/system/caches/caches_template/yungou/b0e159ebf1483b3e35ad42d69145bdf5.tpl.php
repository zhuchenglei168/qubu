...
<!-- 内页顶部 -->
   ...
   <section>
	<div class="mainCon">
    	<div class="mBanner">
        	<ul>
            	<li class="mUserHead"><img src="<?php echo $member['img']; ?>"></li><li class="mUserInfo"><p><?php echo get_user_name($member['uid']); ?></p><br/>梦想分：<?php echo $member['score']; ?><br/>经验值：<?php echo $member['jingyan']; ?><span class="z-class-icon03"><s></s><?php echo $member['yungoudj']; ?></span></li>
            </ul>
        </div>
