	...
	<div class="site_top">
		...
		<li class="fr yu_ff">
			...
			<div class="h_1yyg_eject">
				...
				<dd><a  href="<?php echo WEB_PATH; ?>/member/home">获得商品</a></dd>
...
<style type="text/css">
	.qrcode {
	    ...
	    bottom: 100px;
	    width: 150px;
	    background: #FFF url("../statics/templates/yungou/images/onlinebg.jpg") no-repeat scroll 0px 0px;
	...
	.qrcode .bd ul li .qq {
	    background: transparent url("../statics/templates/yungou/images//btn_qqo.png") no-repeat scroll 0% 0%;
	}
	.qrcode .bd ul li .ww {
	    background: transparent url("../statics/templates/yungou/images//btn_wwo.png") no-repeat scroll 0% 0%;
	}
