...
<!-- 内页顶部 -->
    ...
    <section class="goodsCon">
	    <div class="cSingleCon">
			<p class="cEntry">Shared by <em class="orange"><?php echo count($shaidan); ?></em> people, <em class="orange"><?php echo $sum; ?></em> comments</p>
					...
					<div class="cSingleR m-round" id="<?php echo $sd['sd_id']; ?>">
						<ul>
							...
							<?php 
							 ...
							 ?>							
							<li><h3><b>Phase <?php echo $qs['qishu']; ?></b> <?php echo date('Y-m-d H:i:s',$sd['sd_time']); ?></h3></li>
							...
							<li><dd><s></s><strong><?php echo $sd['sd_zhan']; ?></strong> people envy and jealousy</dd><dd><i></i><strong><?php echo $sd['sd_ping']; ?></strong> comments</dd></li>
