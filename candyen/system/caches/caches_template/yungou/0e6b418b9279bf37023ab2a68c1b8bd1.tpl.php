...
<!-- 内页顶部 -->
    ...
    <header class="g-header">
        <div class="head-l">
	        <a href="javascript:;" onclick="history.go(-1)" class="z-HReturn"><s></s><b>Cack</b></a>
        </div>
        <h2>Calculation results</h2>
        <div class="head-r">
	        <a id="btnCalMethod" href="javascript:;" class="z-RCornerBtn"><i></i>Method</a>
        </div>
    </header>
    ...
    <section id="calResult" class="z-minheight">
        <div id="divGoodsLoading" class="loading loading2"><b></b>Loading</div>
    </section>
