...
<!-- 内页顶部 -->
    ...
    <header class="g-header">
        ...
        <div class="head-r">
	        ...
	        <a id="btnSort" href="javascript:;" class="z-sort"><i></i>Sort<s class="z-SswOn"></s><s class="z-SswNt"></s></a>
	...
	<?php if($co < 1): ?>
		...
		<div id="divNone" class="haveNot z-minheight" style="display:block"><s></s><p>Sorry, no record yet!</p></div>
           ...
           <?php $ln=1;if(is_array($cords)) foreach($cords AS $c): ?> 
			...
			<ul>
				...
				<li class="rInfo"><a href="<?php echo WEB_PATH; ?>/mobile/mobile/userindex/<?php echo $c['uid']; ?>"><?php echo userid($c['uid'],'username'); ?></a>
					...
					<span>Bought <b class="orange"><?php echo $c['gonumber']; ?></b> times</span><em class="arial"><?php echo date("Y-m-d H:i:s",$c['time']); ?></em>
