...
<!-- 内页顶部 -->
    ...
    <section class="clearfix g-Cart">
				...
				<?php 
                 ...
                 ?>    
					<li>		            
						...
						<div class="u-Cart-r">
							<p class="z-Cart-tt"><a href="<?php echo WEB_PATH; ?>/mobile/mobile/item/<?php echo $val['id']; ?>" class="gray6">(Phase <?php echo $val['qishu']; ?>)<?php echo $val['title2']; ?></a></p>
							<ins class="z-promo gray9">surplus <em class="arial"><?php echo $val['zongrenshu']-$val['canyurenshu']; ?></em>  </ins>
							<p class="gray9">total <?php echo _cfg('web_name_two'); ?>：<em class="arial"><?php echo $Mcartlist[$val['id']]['num']; ?></em>/<em class="orange arial">$<?php echo $Mcartlist[$val['id']]['sun']; ?></em></p>
	    ...
	    <div id="divBtmMoney" class="g-Total-bt"><p>Total <?php echo _cfg('web_name_two'); ?>
			<span class="orange arial z-user"><?php echo $num; ?></span> goods  Total amount：
			<span class="orange arial">$<?php echo $buyshopmoney; ?>.00</span> </p>
			<a href="javascript:;" class="orgBtn">settlement</a>
		</div>
	<?php endif; ?>
	    <div id="divNone" class="haveNot z-minheight" style="display:none"><s></s><p>Sorry, there is no product record in your shopping cart!</p>
		</div>
