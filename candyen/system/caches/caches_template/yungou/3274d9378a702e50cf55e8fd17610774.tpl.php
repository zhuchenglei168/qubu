...
<head>
    ...
    <title>My <?php echo _cfg('web_name_two'); ?> record</title>
...
<!-- 内页顶部 -->
    ...
    <header class="g-header">
        ...
        <h2>My <?php echo _cfg('web_name_two'); ?> record</h2>
        <div class="head-r">
    ...
    <div id="navBox" class="g-snav m_listNav">
		    <div class="g-snav-lst z-sgl-crt" state="-1"><a href="javascript:;" class="gray9">All</a></div>
		    <div class="g-snav-lst" state="1"><a href="javascript:;" class="gray9">In progress</a><b></b></div>
		    <div class="g-snav-lst" state="3"><a href="javascript:;" class="gray9">Unveiled</a></div>
    </div>
