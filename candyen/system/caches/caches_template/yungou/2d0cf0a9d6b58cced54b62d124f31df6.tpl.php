...
<!-- 内页顶部 -->
    ...
    <section class="clearfix g-member">
	    ...
	    <article class="clearfix m-round g-userMoney">
		    ...
		    <a href="<?php echo WEB_PATH; ?>/mobile/home/userrecharge" class="z-Recharge-btn">Recharge</a>Current balance<span class="orange"><?php echo $member['money']; ?></span>
	    ...
	    <article class="mt10 m-round">
		    ...
		    <ul class="m-userMoneyNav">
			    ...
			    <li><a id="btnConsumption" href="javascript:;"><b>Consumption details</b>(Total consumption amount：<?php echo $xfsum; ?>)</a><s></s></li>

			    <li><a id="btnRecharge" href="javascript:;"><b>Recharge details</b>(Total recharge amount：<?php echo $czsum; ?>)</a></li>
		    ...
		    <div id="divLoad" class="loading"><b></b>Loading</div>
