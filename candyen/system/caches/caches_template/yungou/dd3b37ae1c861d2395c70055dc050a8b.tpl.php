...
<!-- 内页顶部 -->
    ...
    <section class="clearfix g-Record-ct">
		...
		<?php 
		 ...
		 ?>
			...
			<p>Winner：<em class="blue"><?php echo get_user_name($itemlist[0]['q_uid']); ?></em></p>
			<p>Opening time：<em class="gray6"><?php echo microt($itemlist[0]['q_end_time']); ?></em></p>
			<?php  else: ?>
			<p>Winner：<em class="blue">It's coming out...</em></p>
			<p>Opening time：<em class="gray6">It's coming out...</em></p>
			<?php endif; ?>
		<?php  else: ?>
		 <div class="Progress-bar">
			 ...
			 <span class="pging"></span>
				...
				<ul class="Pro-bar-li">
				<li class="P-bar01"><em><?php echo $itemlist['0']['canyurenshu']; ?></em>Participated</li>
				<li class="P-bar02"><em><?php echo $itemlist['0']['zongrenshu']; ?></em>Total</li>
				<li class="P-bar03"><em><?php echo $itemlist['0']['zongrenshu']-$itemlist['0']['canyurenshu']; ?></em>Surplus</li>
			 </ul>
		 </div>
		<?php endif; ?>
		 </div>
    ...
    <section class="clearfix g-member g-Record-ctlst">
	    ...
	    <article class="m-round">
		    <h3>You have <em class="orange"><?php echo $count; ?></em> lucky codes in total</h3>
		    <ul>
			<?php $ln=1;if(is_array($itemlist)) foreach($itemlist AS $val): ?>
			    <li><p class="gray9"><?php echo microt($val['timego']); ?><span><?php echo $val['gonumber']; ?></span></p><b><?php echo yunma($val['goucode'],"b"); ?></b></li>
