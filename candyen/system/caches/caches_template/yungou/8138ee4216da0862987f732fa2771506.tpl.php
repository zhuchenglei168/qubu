...
<div class="footer mt20">
	...
	<div class="g-copyrightCon">
		...
		<!-- //底部短连接 -->
			<div class="g-links">
				<?php echo Getheader('foot'); ?><script src="http://s22.cnzz.com/stat.php?id=4535640&web_id=4535640" language="JavaScript"></script>
			</div>
...
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"一元云购，收获惊喜的网站！1元就购iphone6S","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"16"},"slide":{"type":"slide","bdImg":"2","bdPos":"right","bdTop":"100"}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];</script>
