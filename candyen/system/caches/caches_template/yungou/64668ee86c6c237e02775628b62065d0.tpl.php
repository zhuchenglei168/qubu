            ...
            <div class="R-content">
                    ...
                    <ul class="m-useraddresslst ">
                        <li class="pad"><span>Detailed address</span><span>consignee</span><span>Default or not</span><span>operation</span></li>
                               ...
                               <li class="pad" id="item_<?php echo $dz['id']; ?>" shr="<?php echo $dz['shouhuoren']; ?>" yb="<?php echo $dz['youbian']; ?>" mob="<?php echo $dz['mobile']; ?>">
                                 <span  id="dizh_<?php echo $dz['id']; ?>"><?php echo $dz['jiedao']; ?></span>
                                 <span><?php echo $dz['shouhuoren']; ?></span>
                                 <span>  <?php if($dz['default'] == 'Y'): ?> Default address <?php  else: ?><a class="xiugai" href="javascript:;"   onclick="setdf(<?php echo $dz['id']; ?>)" title="Set as default">Set as default</a> <?php endif; ?> </span>
                                 <span>
                                    <a class="xiugai" href="javascript:;"   onclick="update(<?php echo $dz['id']; ?>)" title="Edit">Edit</a>
                                    <a class="xiugai" href="javascript:;"   onclick="dell(<?php echo $dz['id']; ?>)" title="Delete">Delete</a>
                                 </span>
                             </li>
