...
<div id="right">
	...
	<div class="right_top">
    	...
    	<a href="javascript:;" onClick="btn_iframef5();" class="system_button"><span>刷新框架</span></a>
            ...
            <!--<a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/cache/init" class="system_button"><span>清空缓存</span></a>

	<a href="#" target="_blank" class="system_button"><span>提交工单</span></a>	-->	
